...
*/
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<CameraActivity2> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(CameraActivity2 activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            CameraActivity2 activity = mActivityWeakReference.get();
