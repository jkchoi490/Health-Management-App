...
public class DBHandler extends SQLiteOpenHelper {
    ...
    // below variable id for our  성별 column.
    private static final String GENDER_COL = "gender";

    // below variable for our 평소운동량 column.
    private static final String EXERCISE_COL = "exercise";

    // below variable is for our 키 column.
    private static final String HEIGHT_COL = "height";

    //내가작성한것 하루 필요열량
    // private static final String DAILY_CALORIES = "dailycalories";//
