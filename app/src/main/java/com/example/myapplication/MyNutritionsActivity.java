...
//    Map<String, Integer> map = (Map<String, Integer>)intent.getSerializableExtra("map");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandlerNutrition = new DBHandlerNutrition(MyNutritionsActivity.this);
...
//프로그레스바============================================================================
        ...
        //======================================================================================
        Button button_recommend = findViewById(R.id.button_recommend);
        ...
        try{
            ...
            if(u_po_ji > poji_value){
                String poji = "poji";
                value_count.add(poji);
            }
         ...
         //   System.out.println("인텐트값 왔는지 확인(nut_list -> nutrition_facts-> map"+map); //map값이 NULL나옴**에러
            ...
            if(change == true){
               button_recommend.setOnClickListener(v -> {
                    Intent intent_over = new Intent(MyNutritionsActivity.this, DialogOverActivity.class);
                    intent_over.putParcelableArrayListExtra("value_count", value_count);
               ...
               button_recommend.setOnClickListener(v -> {
                    ...
                    intent_not_over.putParcelableArrayListExtra("value_count", value_count);
            ...
            System.out.println("영양성분 하루 섭취량 초과한 데이터 넘겨주기 실패");
        }
